...
const TechOrbitDisplay = memo(function TechOrbitDisplay({
  ...
  return (
    <section className='relative flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-lg'>
      <span className='pointer-events-none whitespace-pre-wrap bg-gradient-to-b from-[#00b336] to-[#00b336]/80 bg-clip-text text-center text-4xl font-semibold leading-none text-transparent dark:from-[#00b336] dark:to-[#00b336]/80 drop-shadow-lg'>
        {text}
      </span>
  ...
  return (
    <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          <button
            className='bg-[#00b336] hover:bg-white hover:text-[#00b336] hover:border-[#00b336] hover:border-2 relative group/btn
            block w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] 
              dark:shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset] outline-hidden hover:cursor-pointer transition-all duration-300'
            type='submit'
          >
            {submitButton} &rarr;
            <BottomGradient />
...
const BottomGradient = () => {
  return (
    <>
      <span className='group-hover/btn:opacity-100 block transition duration-500 opacity-0 absolute h-px w-full -bottom-px inset-x-0 bg-gradient-to-r from-transparent via-[#00b336] to-transparent' />
      <span className='group-hover/btn:opacity-100 blur-sm block transition duration-500 opacity-0 absolute h-px w-1/2 mx-auto -bottom-px inset-x-10 bg-gradient-to-r from-transparent via-[#00b336] to-transparent' />
    </>
  );
};
